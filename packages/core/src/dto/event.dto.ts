...
import { PaginatedDateRangeQueryDto } from './pagination.dto';
import {
  UUIDField,
  StringField,
  DateTimeField,
...
/**
 * Event DTOs for frontend and backend communication
 */
...
export class CreateEventRequestDto extends BaseCreateDto {
  @UUIDField('Calendar ID')
  calendarId!: string;
...
export class UpdateEventRequestDto extends BaseUpdateDto {
